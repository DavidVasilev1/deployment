...
public class SecurityConfig {
		...
		public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
			http
				...
				.headers(headers -> headers
					...
					.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Origin", "https://nighthawkcoders.github.io", "http://localhost:4000", "http://127.0.0.1:4000", "https://john-scc.github.io"))
				)
				.formLogin(form -> form 
					.loginPage("/login")
				)
	...
	private CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("https://john-scc.github.io", "http://127.0.0.1:4100", "http://127.0.0.1:4000"));
